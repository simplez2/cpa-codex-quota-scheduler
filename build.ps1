# Build the Codex Quota Scheduler plugin into a Windows .dll.
#
# Requirements:
...
#         plugins/windows/amd64/codex-quota-scheduler.dll
#   (CPA also accepts it directly under plugins/ . The plugin id is the file
#    name without the extension: "codex-quota-scheduler".)

$ErrorActionPreference = "Stop"

$out = "codex-quota-scheduler.dll"
